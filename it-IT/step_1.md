...
+ [Risorse base di progettazione 2D e 3D](https://curriculum.raspberrypi.org/design/creator/){:target="_blank"}.

### Informazioni aggiuntive per gli educatori

Se intendete stampare questo progetto, cliccate su [Versione stampabile](https://projects.raspberrypi.org/en/projects/blender-rocket/print){:target = "_ blank"}.
